import { renderYearDigits as renderYearDigitPaths } from "./digits.js?v=b96";
import { renderDividerLines, renderMarkerPaths, renderMonthDigits } from "./parts.js?v=b96";
import { BADGE_CENTER, BADGE_PROFILE, tuevColorForYear } from "./profile.js?v=b96";

export { tuevColorForYear } from "./profile.js?v=b96";
