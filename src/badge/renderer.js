import { renderYearDigits as renderYearDigitPaths } from "./digits.js?v=b63";
import { renderDividerLines, renderMarkerPaths, renderMonthDigits } from "./parts.js?v=b63";
import { BADGE_CENTER, BADGE_PROFILE, tuevColorForYear } from "./profile.js?v=b63";

export { tuevColorForYear } from "./profile.js?v=b63";
