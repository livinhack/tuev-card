import { renderYearDigits as renderYearDigitPaths } from "./digits.js?v=b66";
import { renderDividerLines, renderMarkerPaths, renderMonthDigits } from "./parts.js?v=b66";
import { BADGE_CENTER, BADGE_PROFILE, tuevColorForYear } from "./profile.js?v=b66";

export { tuevColorForYear } from "./profile.js?v=b66";
