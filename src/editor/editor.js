...
import { createGroup, getNewGroupTitle, getUngroupedEntityIdsFromConfig, normalizeGroups, normalizeGroupSort, normalizeGroupSortDirection, getGroupAccentColor } from "../card/groups.js?v=b351";
...
import { normalizePlate as rendererBoundaryNormalizePlate } from "../plate/renderer.js?v=b351";
import {
    getColumnLabel
...
export class TuevCardEditor extends HTMLElement {
    ...
    moveGroup(groupId, direction) {
        ...
        const nextGroups = this._draftGroups.map((group, groupIndex) => ({
            ...group,
            color: group.color || getGroupAccentColor(group, groupIndex)
        }));
