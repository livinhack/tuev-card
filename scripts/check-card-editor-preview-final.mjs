...
assert(card.includes('from "./plate/renderer.js?v=b341"'), "Card entry must consume the b341 public renderer cache boundary.");
assert(renderer.includes('from "./lab-renderer-adapter.js?v=b341"'), "Public renderer entry must delegate to the b341 adapter cache boundary.");
