...
assert(card.includes('from "./plate/renderer.js?v=b352"'), "Card must use the b352 renderer cache marker.");
assert(editor.includes('from "../plate/renderer.js?v=b352"'), "Editor must use the b352 renderer cache marker.");
assert(renderer.includes('from "./lab-renderer-adapter.js?v=b352"'), "Public renderer must use the b352 adapter cache marker.");
...
assert(editor.includes('getGroupAccentColor') && editor.includes('../card/groups.js?v=b352'), "Editor must import the group color helper through the b352 groups boundary.");
assert(groups.includes('./entities.js?v=b352'), "Groups helper must use the b352 entities cache marker.");

assert(readme.includes("b352") && /Kennzeichen grafisch darstellen/i.test(readme), "README must document the b352 editor option fix.");
assert(handover.includes("b352") && /Sortier/i.test(handover) && /Farben/i.test(handover), "HANDOVER must document b352 sort and color fixes.");
