...
assert(editor.includes('from "../plate/renderer.js?v=b346"'), 'editor must keep the public renderer boundary import without font probes');
...
console.log('✓ b346 card/editor sort-font-frame fix checks passed');
