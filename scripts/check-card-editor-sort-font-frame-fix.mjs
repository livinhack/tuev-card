...
assert(editor.includes('from "../plate/renderer.js?v=b351"'), 'editor must keep the public renderer boundary import without font probes');
...
console.log('✓ b351 card/editor sort-font-frame fix checks passed');
