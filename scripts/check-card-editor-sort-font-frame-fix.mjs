...
assert(editor.includes('from "../plate/renderer.js?v=b341"'), 'editor must keep the public renderer boundary import without font probes');
...
console.log('✓ b341 card/editor sort-font-frame fix checks passed');
