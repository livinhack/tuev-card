...
assert(editor.includes('from "../plate/renderer.js?v=b348"'), 'editor must keep the public renderer boundary import without font probes');
...
console.log('✓ b348 card/editor sort-font-frame fix checks passed');
