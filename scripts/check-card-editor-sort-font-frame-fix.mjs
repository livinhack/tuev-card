...
assert(editor.includes('from "../plate/renderer.js?v=b350"'), 'editor must keep the public renderer boundary import without font probes');
...
console.log('✓ b350 card/editor sort-font-frame fix checks passed');
