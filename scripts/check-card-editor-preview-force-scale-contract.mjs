...
assert(card.includes('width: ${layoutContext.visiblePreviewWidth ? `${layoutContext.visiblePreviewWidth}px` : "100%"};'), 'scaled preview outer wrapper must use the visible preview width, not the possibly oversized host width.');
