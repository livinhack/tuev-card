...
assert(readme.includes("b340"), "README must identify the current b340 stand.");
assert(handover.includes("b340"), "HANDOVER must identify the current b340 stand.");
...
assert(renderer.includes('./lab-renderer-adapter.js?v=b340'), "Public renderer entry must delegate to the b340 adapter cache marker.");
...
if (!process.exitCode) {
  console.log("Post-plate Card open-tasks audit OK: b340 markers, frozen/prepared plate status, remaining Card buckets, font note, and later Reminder integration are documented.");
}
