...
assert(readme.includes("b352"), "README must identify the current b352 stand.");
assert(handover.includes("b352"), "HANDOVER must identify the current b352 stand.");
...
assert(renderer.includes('./lab-renderer-adapter.js?v=b352'), "Public renderer entry must delegate to the b352 adapter cache marker.");
...
if (!process.exitCode) {
  console.log("Post-plate Card open-tasks audit OK: b352 markers, frozen/prepared plate status, remaining Card buckets, font note, and later Reminder integration are documented.");
}
