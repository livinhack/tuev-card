...
assert(readme.includes("b343"), "README must identify the current b343 stand.");
assert(handover.includes("b343"), "HANDOVER must identify the current b343 stand.");
...
assert(renderer.includes('./lab-renderer-adapter.js?v=b343'), "Public renderer entry must delegate to the b343 adapter cache marker.");
...
if (!process.exitCode) {
  console.log("Post-plate Card open-tasks audit OK: b343 markers, frozen/prepared plate status, remaining Card buckets, font note, and later Reminder integration are documented.");
}
