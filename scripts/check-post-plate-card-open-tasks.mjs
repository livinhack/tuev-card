...
assert(readme.includes("b353"), "README must identify the current b353 stand.");
assert(handover.includes("b353"), "HANDOVER must identify the current b353 stand.");
...
assert(renderer.includes('./lab-renderer-adapter.js?v=b353'), "Public renderer entry must delegate to the b353 adapter cache marker.");
...
if (!process.exitCode) {
  console.log("Post-plate Card open-tasks audit OK: b353 markers, frozen/prepared plate status, remaining Card buckets, font note, and later Reminder integration are documented.");
}
