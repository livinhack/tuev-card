...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b62`.
...
```yaml
url: /hacsfiles/tuev-card/tuev-card.js?v=b62
type: module
```
...
2. Change the package version to `0.1.1-b62`.
3. Adjust the bundle release label to `b62`.
4. Run:
