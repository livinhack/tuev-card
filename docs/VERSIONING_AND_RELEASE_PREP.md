...
The project has switched from internal `bXX` checkpoint labels to the first semantic test release `b61`.
...
```yaml
url: /hacsfiles/tuev-card/tuev-card.js?v=b61
type: module
```
...
2. Change the package version to `0.1.1-b61`.
3. Adjust the bundle release label to `b61`.
4. Run:
