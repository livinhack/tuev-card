...
This checkpoint is a repository cleanup before the first semantic `b63` release. It does not intentionally change UI behavior, editor behavior, card rendering, EuroPlate handling, grouping, sorting, or HACS naming.
