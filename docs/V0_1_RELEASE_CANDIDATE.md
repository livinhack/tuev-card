# TÜV Card b58 release notes

Current checked version: `b58`.

This document records the first semantic test release milestone. `b58` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b58`.
...
- Confirm the package version is `0.1.1-b58`.
- Confirm the generated bundle header says `TÜV Card bundled b58`.
...
## Explicitly deferred until after b58
...
1. Copy this `b58` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b58`.
4. Use the release title `b58 - Initial test release`.
