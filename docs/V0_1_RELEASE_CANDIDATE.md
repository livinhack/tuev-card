# TÜV Card b63 release notes

Current checked version: `b63`.

This document records the first semantic test release milestone. `b63` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b63`.
...
- Confirm the package version is `0.1.1-b63`.
- Confirm the generated bundle header says `TÜV Card bundled b63`.
...
## Explicitly deferred until after b63
...
1. Copy this `b63` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b63`.
4. Use the release title `b63 - Initial test release`.
