# TÜV Card b62 release notes

Current checked version: `b62`.

This document records the first semantic test release milestone. `b62` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b62`.
...
- Confirm the package version is `0.1.1-b62`.
- Confirm the generated bundle header says `TÜV Card bundled b62`.
...
## Explicitly deferred until after b62
...
1. Copy this `b62` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b62`.
4. Use the release title `b62 - Initial test release`.
