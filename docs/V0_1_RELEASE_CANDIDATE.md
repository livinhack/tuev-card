# TÜV Card b59 release notes

Current checked version: `b59`.

This document records the first semantic test release milestone. `b59` is based on the confirmed `b42` release candidate and the `b43` repository cleanup checkpoint.

## Release status

- First semantic test release: `b59`.
...
- Confirm the package version is `0.1.1-b59`.
- Confirm the generated bundle header says `TÜV Card bundled b59`.
...
## Explicitly deferred until after b59
...
1. Copy this `b59` ZIP into the repository.
2. Commit and push with GitHub Desktop.
3. Create a GitHub Release with tag `b59`.
4. Use the release title `b59 - Initial test release`.
