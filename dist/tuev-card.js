...
function getPlateFontVariantForText(text) {
...
function getDefaultPlateFontVariant() {
...
const __m_src_plate_physical_layout_js = (() => {
...
const STANDARD_ONE_LINE_PLATE = Object.freeze({
    height: 110,
    maxWidth: 520,
    minWidth: 255,
    cornerRadius: 6,
...
function splitStandardPlate(normalizedPlate) {
...
function getPhysicalPlateLayout({
    normalizedPlate,
    districtWidth,
    identifierWidth,
    fullTextWidth,
...
return { STANDARD_ONE_LINE_PLATE: STANDARD_ONE_LINE_PLATE, splitStandardPlate: splitStandardPlate, getPhysicalPlateLayout: getPhysicalPlateLayout };
...
const { getPhysicalPlateLayout, STANDARD_ONE_LINE_PLATE } = __m_src_plate_physical_layout_js;
...
return { renderEntitySection: renderEntitySection, renderGroupsSection: renderGroupsSection };
